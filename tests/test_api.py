...
def test_dashboard_build_marker_and_cache_busting_are_present() -> None:
    ...
    assert 'src="/static/dashboard.js?v=engineering-understanding-20260715" defer' in html
    assert 'const DASHBOARD_BUILD = "engineering-understanding-20260715"' in js
